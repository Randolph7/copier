...
const ::uint32_t TableStruct_kv_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::kv::KV, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::kv::KV, _impl_.key_),
    PROTOBUF_FIELD_OFFSET(::kv::KV, _impl_.value_),
};
...
KV::KV(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:kv.KV)
}
KV::KV(const KV& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  KV* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.value_) {}
  ...
  // @@protoc_insertion_point(copy_constructor:kv.KV)
}
...
KV::~KV() {
  // @@protoc_insertion_point(destructor:kv.KV)
...
void KV::Clear() {
// @@protoc_insertion_point(message_clear_start:kv.KV)
...
const char* KV::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
::uint8_t* KV::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:kv.KV)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:kv.KV)
  return target;
}

::size_t KV::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:kv.KV)
  ::size_t total_size = 0;
...
void KV::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<KV*>(&to_msg);
  auto& from = static_cast<const KV&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:kv.KV)
...
// @@protoc_insertion_point(class_specific_copy_from_start:kv.KV)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::kv::KV*
Arena::CreateMaybeMessage< ::kv::KV >(Arena* arena) {
  return Arena::CreateMessageInternal< ::kv::KV >(arena);
}
