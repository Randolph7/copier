...
extern int add_to_buffer (struct buffer_s *buffptr, unsigned char *data,
                          size_t length);
extern int add_to_bufferCopier (struct buffer_s *buffptr, unsigned char *data,
                          size_t length);

extern ssize_t read_buffer (int fd, struct buffer_s *buffptr);
extern ssize_t write_buffer (int fd, struct buffer_s *buffptr);
extern ssize_t read_buffer_lazy (int fd, struct buffer_s *buffptr);
extern ssize_t write_buffer_lazy (int fd, struct buffer_s *buffptr);
