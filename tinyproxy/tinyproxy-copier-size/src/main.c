...
void mmapSyncQueueSend(int fd)
{
        cp_in_queue = (struct cp_in_queue *)mmap(NULL, sizeof(struct cp_in_queue), PROT_READ | PROT_WRITE, MAP_SHARED, fd, 0);
}
